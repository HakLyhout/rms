...
class ProductController extends Controller
{
    ...
    public function unactive_product($product_id)
    {
        ...
        Session::put('message','This Product is Unactive !!');
    ...
    public function active_product($product_id)
    {
        ...
        Session::put('message','This Product is active !!');
        return Redirect::to('/all-product');
    }
     public function delete_product($product_id,$image_url)
    {   
        $product_info = DB::table('tbl_product')
            ->where('product_id',$product_id)
            ->where('product_image','=',$image_url)
            ->first();
        $upload_path = "img/";
        $image_to_delete = $upload_path.$image_url;
        $success = $image_url->unlink($image_to_delete);
         if($success)
            {
            DB::table('tbl_product')
                ->where('product_id',$product_id)
    ...
    public function update_product(Request $request,$product_id)
    {
        ...
        Session::put('message','This Product is updated');
        return Redirect::to('/all-product');
    }
}
