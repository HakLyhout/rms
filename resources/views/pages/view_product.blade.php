				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h3 class="product-price">{{$product_by_details->product_price}}</h3>
							<div>
							...
							<div class="product-options">
								<ul class="size-option">
									...
									<li class="active"><a href="#">{{$product_by_details->product_size}}</a></li>
								</ul>
							...
							<div class="product-btns">
								<form action="{{url('/add_to_cart')}}" method="post">
									...
									<div class="qty-input">
										...
										<input class="input" name="qty" type="number" >
										<input class="hidden" name="product_id" value="{{$product_by_details->product_id}}">
									</div>
