						...
						<form class="form-horizontal"   action="{{ url('/update_product',$product_info->product_id)}}" method="post" enctype="multipart/form-data">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" value="{{$product_info->product_name}}" name="product_name" required="">
							  </div>
							</div>
							 <div class="control-group">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_short_description" value="{{$product_info->product_short_description}}" id="textarea2" rows="3"></textarea>
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Long Description</label>
							  <div class="controls">
								<textarea class="cleditor" name="product_long_description" value="{{$product_info->product_long_description}}" id="textarea2" rows="3"></textarea>
							  </div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
								  <div class="input-prepend input-append">
									<span class="add-on">$</span><input id="appendedPrependedInput" name="product_price" value="{{$product_info->product_price}}" size="16" type="text"><span class="add-on">.00</span>
								  </div>
								</div>
							  </div>
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" value="{{$product_info->product_size}}" name="product_size" required="">
							  </div>
							</div>
							 <div class="control-group">
							  <label class="control-label" for="typeahead">Color </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="product_color" value="{{$product_info->product_color}}" required="">
							  </div>
							</div>
							<div class="control-group">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<input type="checkbox" name="publication_status" value="{{$product_info->publication_status}}" value="1">
							  </div>
							</div>
